// following were autogenerated by ./codegen/flatten_group_generator.rb at 2016-01-20 13:37:24 +0100 do not edit
...
object FlattenGroup {
  ...
  class FlattenLeftJoin3[KEY, KLL[KLL_K, +KLL_V] <: KeyedListLike[KLL_K, KLL_V, KLL], A, B, C](nested: KLL[KEY, ((A, B), C)])(implicit mfA: ClassTag[A], mfB: ClassTag[B], mfC: ClassTag[C]) {
    def flattenValueTuple: KLL[KEY, (A, B, C)] = nested.mapValues { tup => FlattenGroup.flattenNestedTuple(tup) }
  }

  implicit def toFlattenLeftJoin3[KEY, KLL[KLL_K, +KLL_V] <: KeyedListLike[KLL_K, KLL_V, KLL], A, B, C](nested: KLL[KEY, ((A, B), C)])(implicit mfA: ClassTag[A], mfB: ClassTag[B], mfC: ClassTag[C]) = new FlattenLeftJoin3(nested)
  ...
  class FlattenLeftJoin4[KEY, KLL[KLL_K, +KLL_V] <: KeyedListLike[KLL_K, KLL_V, KLL], A, B, C, D](nested: KLL[KEY, (((A, B), C), D)])(implicit mfA: ClassTag[A], mfB: ClassTag[B], mfC: ClassTag[C], mfD: ClassTag[D]) {
    def flattenValueTuple: KLL[KEY, (A, B, C, D)] = nested.mapValues { tup => FlattenGroup.flattenNestedTuple(tup) }
  }

  implicit def toFlattenLeftJoin4[KEY, KLL[KLL_K, +KLL_V] <: KeyedListLike[KLL_K, KLL_V, KLL], A, B, C, D](nested: KLL[KEY, (((A, B), C), D)])(implicit mfA: ClassTag[A], mfB: ClassTag[B], mfC: ClassTag[C], mfD: ClassTag[D]) = new FlattenLeftJoin4(nested)
  ...
  class FlattenLeftJoin5[KEY, KLL[KLL_K, +KLL_V] <: KeyedListLike[KLL_K, KLL_V, KLL], A, B, C, D, E](nested: KLL[KEY, ((((A, B), C), D), E)])(implicit mfA: ClassTag[A], mfB: ClassTag[B], mfC: ClassTag[C], mfD: ClassTag[D], mfE: ClassTag[E]) {
    def flattenValueTuple: KLL[KEY, (A, B, C, D, E)] = nested.mapValues { tup => FlattenGroup.flattenNestedTuple(tup) }
  }

  implicit def toFlattenLeftJoin5[KEY, KLL[KLL_K, +KLL_V] <: KeyedListLike[KLL_K, KLL_V, KLL], A, B, C, D, E](nested: KLL[KEY, ((((A, B), C), D), E)])(implicit mfA: ClassTag[A], mfB: ClassTag[B], mfC: ClassTag[C], mfD: ClassTag[D], mfE: ClassTag[E]) = new FlattenLeftJoin5(nested)
  ...
  class FlattenLeftJoin6[KEY, KLL[KLL_K, +KLL_V] <: KeyedListLike[KLL_K, KLL_V, KLL], A, B, C, D, E, F](nested: KLL[KEY, (((((A, B), C), D), E), F)])(implicit mfA: ClassTag[A], mfB: ClassTag[B], mfC: ClassTag[C], mfD: ClassTag[D], mfE: ClassTag[E], mfF: ClassTag[F]) {
    def flattenValueTuple: KLL[KEY, (A, B, C, D, E, F)] = nested.mapValues { tup => FlattenGroup.flattenNestedTuple(tup) }
  }

  implicit def toFlattenLeftJoin6[KEY, KLL[KLL_K, +KLL_V] <: KeyedListLike[KLL_K, KLL_V, KLL], A, B, C, D, E, F](nested: KLL[KEY, (((((A, B), C), D), E), F)])(implicit mfA: ClassTag[A], mfB: ClassTag[B], mfC: ClassTag[C], mfD: ClassTag[D], mfE: ClassTag[E], mfF: ClassTag[F]) = new FlattenLeftJoin6(nested)
  ...
  class FlattenOuterJoin3[KEY, KLL[KLL_K, +KLL_V] <: KeyedListLike[KLL_K, KLL_V, KLL], A, B, C](nested: KLL[KEY, (Option[(Option[A], Option[B])], Option[C])])(implicit mfA: ClassTag[A], mfB: ClassTag[B], mfC: ClassTag[C]) {
    def flattenValueTuple: KLL[KEY, (Option[A], Option[B], Option[C])] = nested.mapValues { tup => FlattenGroup.flattenNestedOptionTuple(tup) }
  }

  implicit def toFlattenOuterJoin3[KEY, KLL[KLL_K, +KLL_V] <: KeyedListLike[KLL_K, KLL_V, KLL], A, B, C](nested: KLL[KEY, (Option[(Option[A], Option[B])], Option[C])])(implicit mfA: ClassTag[A], mfB: ClassTag[B], mfC: ClassTag[C]) = new FlattenOuterJoin3(nested)
  ...
  class FlattenOuterJoin4[KEY, KLL[KLL_K, +KLL_V] <: KeyedListLike[KLL_K, KLL_V, KLL], A, B, C, D](nested: KLL[KEY, (Option[(Option[(Option[A], Option[B])], Option[C])], Option[D])])(implicit mfA: ClassTag[A], mfB: ClassTag[B], mfC: ClassTag[C], mfD: ClassTag[D]) {
  ...
  implicit def toFlattenOuterJoin4[KEY, KLL[KLL_K, +KLL_V] <: KeyedListLike[KLL_K, KLL_V, KLL], A, B, C, D](nested: KLL[KEY, (Option[(Option[(Option[A], Option[B])], Option[C])], Option[D])])(implicit mfA: ClassTag[A], mfB: ClassTag[B], mfC: ClassTag[C], mfD: ClassTag[D]) = new FlattenOuterJoin4(nested)
  ...
  class FlattenOuterJoin5[KEY, KLL[KLL_K, +KLL_V] <: KeyedListLike[KLL_K, KLL_V, KLL], A, B, C, D, E](nested: KLL[KEY, (Option[(Option[(Option[(Option[A], Option[B])], Option[C])], Option[D])], Option[E])])(implicit mfA: ClassTag[A], mfB: ClassTag[B], mfC: ClassTag[C], mfD: ClassTag[D], mfE: ClassTag[E]) {
  ...
  implicit def toFlattenOuterJoin5[KEY, KLL[KLL_K, +KLL_V] <: KeyedListLike[KLL_K, KLL_V, KLL], A, B, C, D, E](nested: KLL[KEY, (Option[(Option[(Option[(Option[A], Option[B])], Option[C])], Option[D])], Option[E])])(implicit mfA: ClassTag[A], mfB: ClassTag[B], mfC: ClassTag[C], mfD: ClassTag[D], mfE: ClassTag[E]) = new FlattenOuterJoin5(nested)
  ...
  class FlattenOuterJoin6[KEY, KLL[KLL_K, +KLL_V] <: KeyedListLike[KLL_K, KLL_V, KLL], A, B, C, D, E, F](nested: KLL[KEY, (Option[(Option[(Option[(Option[(Option[A], Option[B])], Option[C])], Option[D])], Option[E])], Option[F])])(implicit mfA: ClassTag[A], mfB: ClassTag[B], mfC: ClassTag[C], mfD: ClassTag[D], mfE: ClassTag[E], mfF: ClassTag[F]) {
  ...
  implicit def toFlattenOuterJoin6[KEY, KLL[KLL_K, +KLL_V] <: KeyedListLike[KLL_K, KLL_V, KLL], A, B, C, D, E, F](nested: KLL[KEY, (Option[(Option[(Option[(Option[(Option[A], Option[B])], Option[C])], Option[D])], Option[E])], Option[F])])(implicit mfA: ClassTag[A], mfB: ClassTag[B], mfC: ClassTag[C], mfD: ClassTag[D], mfE: ClassTag[E], mfF: ClassTag[F]) = new FlattenOuterJoin6(nested)
